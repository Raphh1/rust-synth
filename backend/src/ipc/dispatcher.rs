...
/// Etat partagé entre le dispatcher (thread IPC) et l'engine audio.
/// Les paramètres DSP sont stockés ici ; l'audio thread les lit à chaque buffer.
...
/// Dispatche une commande IPC vers l'état du moteur.
